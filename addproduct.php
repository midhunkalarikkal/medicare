  ...
  <body class="violetgradient">
    ...
    <center>
        <div class="customalert">
            <div class="alertcontent">
                ...
                <button class="formbtn" onclick="downloadImage()"> Download QR <i class="fa fa-download" aria-hidden="true"></i></button>
    ...
    <div class="bgrolesadd">
      <center>
        ...
        <iframe src="https://cdscoonline.gov.in/CDSCO/soam/drug_data.jsp" frameborder="0" class="iframecontent"></iframe>
        </div>
    ...
    <!--Editing for saving prodname to database-->

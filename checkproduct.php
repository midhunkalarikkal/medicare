    ...
    <center>
      ...
      <div>     
        ...
        <div class="col">
          ...
          <!--The main form form entering medicine id--->
            <form role="form" autocomplete="off">
              ...
              <input type=file accept="image/*" id="selectedFile" style="display:none" capture=environment onchange="openfile(this);" tabindex=-1>
              </label>

  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="maincard4">
            ...
            <form style="margin-top: 30px; margin-bottom: 30px;" action="validation.php" method="POST" onsubmit="return checkSecondForm(this);">

            <label type="text" class="formlabel"> Enter your email id </label>
            <input type="email" class="forminput" name="email" id="value" onkeypress="isNotChar(event)" required>

            <button class="formbtn" name="submit" id="loginsubmit" value="submitted!" type="submit">Send otp</button>
      ...
      <!--Editing start for adding the same form without unique id-->
      ...
      <!--Editing end for adding the same form without unique id-->
    ...
    /** Editing start for id function */
    
    /** Editing end for id function */

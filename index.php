        ...
        <div class="loginformcard" id="card1" style="margin-top: 220px;">
          ...
          <h3> Welcome to the supply shain WEB 3 - APP </h4>
            <p style="max-width: 80%;">
              <strong>MEDICARE</strong> is a Decentralized E2E Application that stores the whereabouts of MEDICINE at
              every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and
              get complete information about the provenance of that product hence empowering consumers to only purchase
